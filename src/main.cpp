...
unsigned int nStakeMinAge = 60 * 60 * 24 * 9000;
unsigned int nStakeMaxAge = 60 * 60 * 24 * 9000;          
...
const int DAILY_BLOCKCOUNT =  1440 / (50.0/60.0);
...
static const int64_t nTargetTimespan = 50 * 15;
//
...
static unsigned int GetNextTargetRequired_(const CBlockIndex* pindexLast, bool fProofOfStake)
{
	...
	if (pindexLast->nHeight == 105 || pindexLast->nHeight == 205 || pindexLast->nHeight == 405)
...
unsigned char pchMessageStart[4] = { 0xd1, 0xd0, 0xe2, 0xe4 };
